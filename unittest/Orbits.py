...
#o = OrbitRV(Mass.fromKg(1.8e15), 7490, 4.5)
#print("Apoapsis=", o.apoapsis, "v(ap)=", o.v(o.apoapsis).length)
#print("P=", o.P/3600)
...
#o = Orbit(Mass.fromKg(1.8e15), 7490+50, 7490)
#print("v0=", o.v(0.0).length)
#print("v1=", o.v(0.5).length)
#print("P=", o.P/3600)
